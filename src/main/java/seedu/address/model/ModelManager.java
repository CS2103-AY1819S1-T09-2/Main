...
public class ModelManager extends ComponentManager implements Model {
    ...
    public ModelManager(ReadOnlyAddressBook addressBook, UserPrefs userPrefs) {
        ...
        filteredDecks = new FilteredList<>(versionedAddressBook.getPersonList());
    }
    ...
    public boolean hasPerson(Deck deck) {
        requireNonNull(deck);
        return versionedAddressBook.hasPerson(deck);
    }
    ...
    public void addPerson(Deck deck) {
        versionedAddressBook.addPerson(deck);
    ...
    public void updatePerson(Deck target, Deck editedDeck) {
        ...
        versionedAddressBook.updatePerson(target, editedDeck);
        indicateAddressBookChanged();
    }
