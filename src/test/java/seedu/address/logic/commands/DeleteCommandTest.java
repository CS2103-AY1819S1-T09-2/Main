...
public class DeleteCommandTest {
    ...
    public void execute_validIndexUnfilteredList_success() {
        Deck deckToDelete = model.getFilteredPersonList().get(INDEX_FIRST_PERSON.getZeroBased());
        DeleteCommand deleteCommand = new DeleteCommand(INDEX_FIRST_PERSON);

        String expectedMessage = String.format(DeleteCommand.MESSAGE_DELETE_PERSON_SUCCESS, deckToDelete);

        ModelManager expectedModel = new ModelManager(model.getAddressBook(), new UserPrefs());
        expectedModel.deletePerson(deckToDelete);
    ...
    /**
     * 1. Deletes a {@code Deck} from a filtered list.
     * 2. Undo the deletion.
    ...
    public void executeUndoRedo_validIndexFilteredList_samePersonDeleted() throws Exception {
        ...
        assertNotEquals(deckToDelete, model.getFilteredPersonList().get(INDEX_FIRST_PERSON.getZeroBased()));
