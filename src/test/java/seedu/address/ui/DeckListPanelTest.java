...
public class DeckListPanelTest extends GuiUnitTest {
    ...
    public void display() {
        ...
        for (int i = 0; i < TYPICAL_DECKS.size(); i++) {
            personListPanelHandle.navigateToCard(TYPICAL_DECKS.get(i));
            Deck expectedDeck = TYPICAL_DECKS.get(i);
            PersonCardHandle actualCard = personListPanelHandle.getPersonCardHandle(i);

            assertCardDisplaysPerson(expectedDeck, actualCard);
     ...
     */
    private ObservableList<Deck> createBackingList(int personCount) throws Exception {
