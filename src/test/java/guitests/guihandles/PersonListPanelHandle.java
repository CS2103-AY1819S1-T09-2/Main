 ...
 */
public class PersonListPanelHandle extends NodeHandle<ListView<Deck>> {
    public static final String PERSON_LIST_VIEW_ID = "#personListView";

    private static final String CARD_PANE_ID = "#cardPane";

    private Optional<Deck> lastRememberedSelectedPersonCard;

    public PersonListPanelHandle(ListView<Deck> personListPanelNode) {
    ...
    public boolean isAnyCardSelected() {
        List<Deck> selectedCardsList = getRootNode().getSelectionModel().getSelectedItems();
    ...
    private Deck getPerson(int index) {
