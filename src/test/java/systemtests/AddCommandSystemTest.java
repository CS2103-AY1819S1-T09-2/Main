...
public class AddCommandSystemTest extends AddressBookSystemTest {
    ...
    public void add() {
        ...
        /* Case: add a deck without tags to a non-empty address book, command with leading spaces and trailing spaces
         * -> added
         */
        Deck toAdd = AMY;
        ...
        /* Case: add a deck with all fields same as another deck in the address book except name -> added */
        toAdd = new PersonBuilder(AMY).withName(VALID_NAME_BOB).build();
        command = AddCommand.COMMAND_WORD + NAME_DESC_BOB + PHONE_DESC_AMY + EMAIL_DESC_AMY + ADDRESS_DESC_AMY
                + TAG_DESC_FRIEND;
        assertCommandSuccess(command, toAdd);

        /* Case: add a deck with all fields same as another deck in the address book except phone and email
         * -> added
         */
        ...
        /* Case: add a deck with tags, command with parameters in random order -> added */
        toAdd = BOB;
        command = AddCommand.COMMAND_WORD + TAG_DESC_FRIEND + PHONE_DESC_BOB + ADDRESS_DESC_BOB + NAME_DESC_BOB
                + TAG_DESC_HUSBAND + EMAIL_DESC_BOB;
        assertCommandSuccess(command, toAdd);

        /* Case: add a deck, missing tags -> added */
        ...
        /* ------------------------ Perform add operation while a deck card is selected --------------------------- */

        /* Case: selects first card in the deck list, add a deck -> added, card selection remains unchanged */
        ...
        /* Case: add a duplicate deck except with different phone -> rejected */
        ...
        /* Case: add a duplicate deck except with different address -> rejected */
        toAdd = new PersonBuilder(HOON).withAddress(VALID_ADDRESS_BOB).build();
        command = PersonUtil.getAddCommand(toAdd);
        assertCommandFailure(command, AddCommand.MESSAGE_DUPLICATE_PERSON);

        /* Case: add a duplicate deck except with different tags -> rejected */
     ...
     * instead.
     * @see AddCommandSystemTest#assertCommandSuccess(Deck)
     */
     ...
     * @see AddCommandSystemTest#assertCommandSuccess(String, Deck)
     */
