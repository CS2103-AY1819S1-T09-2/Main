...
public class EditCommandSystemTest extends AddressBookSystemTest {
    ...
    public void edit() {
        ...
        Deck editedDeck = new PersonBuilder(BOB).withTags(VALID_TAG_HUSBAND).build();
        ...
        model.updatePerson(
                getModel().getFilteredPersonList().get(INDEX_FIRST_PERSON.getZeroBased()), editedDeck);
        assertCommandSuccess(command, model, expectedResultMessage);
        ...
        command = EditCommand.COMMAND_WORD + " " + index.getOneBased() + NAME_DESC_AMY + PHONE_DESC_BOB + EMAIL_DESC_BOB
                + ADDRESS_DESC_BOB + TAG_DESC_FRIEND + TAG_DESC_HUSBAND;
        editedDeck = new PersonBuilder(BOB).withName(VALID_NAME_AMY).build();
        assertCommandSuccess(command, index, editedDeck);
        ...
        command = EditCommand.COMMAND_WORD + " " + index.getOneBased() + NAME_DESC_BOB + PHONE_DESC_AMY + EMAIL_DESC_AMY
                + ADDRESS_DESC_BOB + TAG_DESC_FRIEND + TAG_DESC_HUSBAND;
        editedDeck = new PersonBuilder(BOB).withPhone(VALID_PHONE_AMY).withEmail(VALID_EMAIL_AMY).build();
        assertCommandSuccess(command, index, editedDeck);

        /* Case: clear tags -> cleared */
        index = INDEX_FIRST_PERSON;
        command = EditCommand.COMMAND_WORD + " " + index.getOneBased() + " " + PREFIX_TAG.getPrefix();
        Deck deckToEdit = getModel().getFilteredPersonList().get(index.getZeroBased());
        editedDeck = new PersonBuilder(deckToEdit).withTags().build();
        assertCommandSuccess(command, index, editedDeck);
        ...
        deckToEdit = getModel().getFilteredPersonList().get(index.getZeroBased());
        editedDeck = new PersonBuilder(deckToEdit).withName(VALID_NAME_BOB).build();
        assertCommandSuccess(command, index, editedDeck);
        ...
        /* Case: edit a deck with new values same as another deck's values but with different address -> rejected */
        command = EditCommand.COMMAND_WORD + " " + index.getOneBased() + NAME_DESC_BOB + PHONE_DESC_BOB + EMAIL_DESC_BOB
    ...
    private void assertCommandSuccess(String command, Index toEdit, Deck editedDeck,
        ...
        expectedModel.updatePerson(expectedModel.getFilteredPersonList().get(toEdit.getZeroBased()), editedDeck);
        expectedModel.updateFilteredPersonList(PREDICATE_SHOW_ALL_PERSONS);

        assertCommandSuccess(command, expectedModel,
                String.format(EditCommand.MESSAGE_EDIT_PERSON_SUCCESS, editedDeck), expectedSelectedCardIndex);
    }
