...
image::ReviewSequenceDiagram.png[width="790", align="left"]
...
image::ReviewActivityDiagram.png[width="790", align="left"]
...
** Pros: Able to easily implement keyboard shortcuts for iterating cards.
